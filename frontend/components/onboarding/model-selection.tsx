...
export default function ModelSelection() {
  ...
  const selectedModelsCount = formData.llmModels.filter(
    (model) => model.selected && !model.comingSoon
  ).length;
  ...
  const getModelLogo = (model) => {
    ...
    if (modelName.includes("gemini")) {
      return (
        ...
        >
          <path
            d="M96 8L16 50V142L96 184L176 142V50L96 8Z"
    ...
    if (modelName.includes("yi")) {
      return (
        ...
        >
          ...
          <path
            d="M16 5L5 16L16 27L27 16L16 5Z"
            stroke="#FF8C00"
            strokeWidth="2"
            fill="#FF8C00"
          />
          ...
          <div className="flex gap-2">
            ...
            <div className="ml-auto flex items-center gap-2">
              <div className="flex items-center">
                ...
                <Badge className={`${modelPlanImpact.color}`}>
                  {modelPlanImpact.plan}
                </Badge>
              </div>
            </div>
          </div>
              ...
              <tbody>
                {filteredModels.length === 0 ? (
                  ...
                  filteredModels.map((model, index) => {
                    ...
                    const formattedDataFreshness = formatDataFreshness(
                      model.dataFreshness
                    );
                    ...
                    return (
                      <tr
                        ...
                        className={`
                          ...
                          ${
                            hoveredRow === model.id && !model.comingSoon
                              ? "bg-gray-100"
                              : ""
                          }
                        ...
                        `}
                        onMouseEnter={() =>
                          !model.comingSoon && setHoveredRow(model.id)
                        }
                          ...
                          <div className="flex items-center gap-2">
                            <div
                              className={`p-1.5 rounded-md ${
                                model.selected ? "bg-accent-200" : "bg-gray-100"
                              } transition-colors duration-200 flex items-center justify-center w-7 h-7 flex-shrink-0`}
                            >
                              {getModelLogo(model)}
                            </div>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>
                              Whether the model can access current web
                              information
                            </p>
                          </TooltipContent>
                        </Tooltip>
                        ...
                        <td className="p-3 border-b border-gray-200">
                          <div className="flex items-center gap-3">
                            <div
                              className={`p-1.5 rounded-md ${
                                model.selected ? "bg-accent-200" : "bg-gray-100"
                              } transition-colors duration-200 flex items-center justify-center w-8 h-8`}
                            >
                              {getModelLogo(model)}
                            </div>
                            <div>
                              <div className="font-medium text-sm flex items-center gap-1.5">
                                ...
                                {model.new && !model.comingSoon && (
                                  <TooltipProvider>
                                    <Tooltip>
                                      <TooltipTrigger asChild>
                                        <Badge className="bg-green-100 text-green-700 px-1 py-0 text-[10px]">
                                          New
                                        </Badge>
                                      </TooltipTrigger>
                                      <TooltipContent>
                                ...
                                {model.comingSoon && (
                                  <TooltipProvider>
                                    <Tooltip>
                                      <TooltipTrigger asChild>
                                        <Badge className="bg-gray-100 text-gray-700 px-1 py-0 text-[10px]">
                                          Coming Soon
                                        </Badge>
                                      </TooltipTrigger>
                                      <TooltipContent>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-gray-700">
                We suggest selecting multiple models for a more comprehensive
                analysis. Different models may have different perceptions of
                your brand, providing you with a more complete picture.
              </p>
              <p className="text-sm text-gray-700 mt-2">
                Models with web access can provide more up-to-date information
                about your brand and competitors. Consider selecting a mix of
                models with different data freshness and capabilities.
              </p>
              {selectedModelsCount > 5 && (
                <div className="mt-3 p-3 bg-accent-50 border border-accent-200 rounded-md">
                  <p className="text-sm font-medium text-accent-700 flex items-center">
                    ...
                    Your selection of {selectedModelsCount} models requires a{" "}
                    {modelPlanImpact.plan} plan or higher
                  </p>
                  <Button
                    variant="link"
                    size="sm"
