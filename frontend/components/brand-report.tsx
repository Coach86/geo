          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Schedule a consultation with our team to discuss these insights
                and develop a strategy to optimize your brand's presence in AI
                responses. Our experts will help you implement the
