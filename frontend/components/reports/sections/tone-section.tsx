...
export default function ToneSection({ data, globalAverage }: ToneSectionProps) {
  ...
  const uniqueModels = Array.from(
    new Set(data.questions.flatMap((q) => q.results.map((r) => r.model)))
  );
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <ul className="mt-1 text-sm text-blue-700 list-disc pl-5 space-y-1">
                  <li>Unique questions tested = {data.questions.length}</li>
                  {/* <li>Sequences run = 3</li> */}
                  <li>
                    Total "Tone" responses generated by model =
                    {data.questions.length.toFixed(2)}
                  </li>
                  <li>
                    {data.questions.length * uniqueModels.length} responses
