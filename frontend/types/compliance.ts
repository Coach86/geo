...
/**
 * Represents a single detailed result from a compliance test run.
 * This often corresponds to one model evaluating one prompt/query.
 */
export interface DetailedComplianceResult {
  ...
  attributeScores: AttributeScore[]; // Scores for various compliance attributes
...
/**
 * Overall summary of compliance results.
 */
export interface ComplianceSummary {
  overallComplianceScore: number; // Overall score, e.g., 0.87 for 87%
...
/**
 * The main structure for compliance results, combining summary and detailed breakdowns.
 */
export interface ComplianceResults {
  summary: ComplianceSummary;
  detailedResults: DetailedComplianceResult[];
}
