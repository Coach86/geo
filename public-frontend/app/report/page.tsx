...
export default function Report() {
  ...
  useEffect(() => {
    const fetchReport = async () => {
      ...
      try {
        ...
        const validationResponse = await fetch(`${apiBaseUrl}/reports/access/validate?token=${token}`)
        ...
        const reportResponse = await fetch(`${apiBaseUrl}/reports/content/${reportId}?token=${token}`);
      ...
      <div className="container mx-auto max-w-7xl py-12">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Please wait while we load your report...</CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="mt-6 text-center text-muted-foreground">Loading your report data</p>
          </CardContent>
        </Card>
      </div>
    )
      ...
      <div className="container mx-auto max-w-7xl py-12">
        <Card>
          <CardHeader>
            ...
            <CardDescription>We encountered a problem loading your report</CardDescription>
          </CardHeader>
          <CardContent>
  ...
  // Render the report using the data from the API
  return (
    <div>
      {/* Render the BrandReport component with the report data */}
