...
export class GenerateTokenResponseDto {
  @ApiProperty({ description: 'Indicates if the token was successfully generated', example: true })
  success: boolean;
  
  @ApiProperty({ description: 'Message about the operation result', example: 'Access token generated successfully' })
  message: string;
}
